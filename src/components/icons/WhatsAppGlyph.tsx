/**
 * Glifo oficial do WhatsApp (não existe no Lucide). Usado em tinta escura
 * dentro do CTA verde para reforçar "isto abre o WhatsApp".
 * `currentColor` permite herdar a cor do texto do botão.
 */
